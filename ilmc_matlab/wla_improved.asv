function [Ln_vec pn_vec pn_orig_vec A_wires A_vias] = wla_improved(Iidf,gate_pitch,min_pitch,layers_per_tier,routing_efficiency,layer_area,rho_m,epsr_d,alpha_t,Beta,Tclk,Rc)
